...
# --- Module Imports ---
from module import func0, func, func2, func2x, func2t, func3, func3x, func4, func4x
from module import func5, func5x2, func6, func7, func8, func_usbond
...
from myapp.models import Stock6Sign, StockPERseg, City, StockFavs_test168, StockFavDB, PriEPSPER_DB
from myapp.models import Stock6Sign202005, Stock6Sign202006, Stock6Sign2020Q2, Stock6Sign202008, Stock6Sign202009
from myapp.models import Stock6Sign2020Q3, Stock6Sign202011, Stock6Sign2020Q4
from myapp.models import Stock6Sign202101, Stock6Sign202102, Stock6Sign202103, Stock6Sign202104, Stock6Sign202105
from myapp.models import Stock6Sign202106, Stock6Sign202107, Stock6Sign202108, Stock6Sign202109, Stock6Sign202110
from myapp.models import Stock6Sign202111, Stock6Sign202112
from myapp.models import Stock6Sign202201, Stock6Sign202202, Stock6Sign202203, Stock6Sign202204, Stock6Sign202205
from myapp.models import Stock6Sign202206, Stock6Sign202207, Stock6Sign202208, Stock6Sign202209, Stock6Sign202210
from myapp.models import Stock6Sign202211, Stock6Sign202212
from myapp.models import Stock6Sign202301, Stock6Sign202302, Stock6Sign202303, Stock6Sign202304, Stock6Sign202305
from myapp.models import Stock6Sign202306, Stock6Sign202307, Stock6Sign202308, Stock6Sign202309, Stock6Sign202310
from myapp.models import Stock6Sign202311, Stock6Sign202312
from myapp.models import Stock6Sign202401, Stock6Sign202402, Stock6Sign202403, Stock6Sign202404, Stock6Sign202405, Stock6Sign202406

from myapp.models import DCStock6Sign202011, DCStock6Sign2020Q4
from myapp.models import DCStock6Sign202101, DCStock6Sign202102, DCStock6Sign202103, DCStock6Sign202104, DCStock6Sign202105
from myapp.models import DCStock6Sign202106, DCStock6Sign202107, DCStock6Sign202108, DCStock6Sign202109, DCStock6Sign202110
from myapp.models import DCStock6Sign202111, DCStock6Sign202112

from myapp.models import StockPERseg202005, StockPERseg202006, StockPERseg2020Q2, StockPERseg202008, StockPERseg202009
from myapp.models import StockPERseg2020Q3, StockPERseg202011, StockPERseg2020Q4
from myapp.models import StockPERseg202101, StockPERseg202102, StockPERseg202103, StockPERseg202104, StockPERseg202105
from myapp.models import StockPERseg202106, StockPERseg202107, StockPERseg202108, StockPERseg202109, StockPERseg202110
from myapp.models import StockPERseg202111, StockPERseg202112
from myapp.models import StockPERseg202201, StockPERseg202202, StockPERseg202203, StockPERseg202204, StockPERseg202205
from myapp.models import StockPERseg202206, StockPERseg202207, StockPERseg202208, StockPERseg202209, StockPERseg202210
from myapp.models import StockPERseg202211, StockPERseg202212
from myapp.models import StockPERseg202301, StockPERseg202302, StockPERseg202303, StockPERseg202304, StockPERseg202305
from myapp.models import StockPERseg202306, StockPERseg202307, StockPERseg202308, StockPERseg202309, StockPERseg202310
from myapp.models import StockPERseg202311, StockPERseg202312
from myapp.models import StockPERseg202401, StockPERseg202402, StockPERseg202403, StockPERseg202404, StockPERseg202405, StockPERseg202406

from myapp.models import EpsProfit2020Q1, EpsProfit2020Q2, EpsProfit2020Q3, EpsProfit2020Q4
from myapp.models import EpsProfit2021Q1, EpsProfit2021Q2, EpsProfit2021Q3, EpsProfit2021Q4
from myapp.models import EpsProfit2022Q1, EpsProfit2022Q3

from myapp.models import StockPERsegStable2020, StockPERsegStable2020Q2, StockPERsegStable2020Q3, StockPERsegStable2020Q3x, StockPERsegStable2020Q4
from myapp.models import StockPERsegStable2021Q1, StockPERsegStable2021Q2, StockPERsegStable2021Q3, StockPERsegStable2021Q4
from myapp.models import StockPERsegStable2022Q1, StockPERsegStable2022Q3

from myapp.models import EPSachieve, EPSachieve2020Q2, EPSachieve2020Q3, EPSachieve2021Q1, EPSachieve2021Q2
from myapp.models import EPSachieve2021Q3, EPSachieve2022Q1, EPSachieve2022Q3

from myapp.models import StockCapVar, StockCapVar2020Q2, StockCapVar2020Q3, StockCapVar2020Q4
from myapp.models import StockCapVar2021Q1, StockCapVar2021Q2, StockCapVar2021Q3, StockCapVar2021Q4
from myapp.models import StockCapVar2022Q1, StockCapVar2022Q3

from myapp.models import SubCats202011, SubCats202102, SubCats202103, SubCats202104, SubCats202105, SubCats202106
from myapp.models import SubCats202107, SubCats202108, SubCats202109, SubCats202110, SubCats202111, SubCats202112
...
# ==============================================================================
try:
    # 嘗試從根目錄匯入 Yieldupdate.py
    sys.path.append('/opt/render/project/src') 
    from Yieldupdate import run_yield_update_task
except ImportError as e:
    print(f"Warning: Yieldupdate module not found. Auto-update disabled. Error: {e}")
    # 定義空函式避免呼叫時錯誤
    def run_yield_update_task():
        print("Error: Yieldupdate module missing.")
...
@permission_required('myapp.Can_enter_AdminOnly', login_url='/login/')
def stockNetCapAdmin(request):
    if request.method == "POST":
        mess0 = request.POST['stockid']
        
        if is_number(mess0) == True:
            mess = mess0
        else:
            mess = tseotc_dict[mess0]

        wholetime = str(datetime.datetime.now()) 
        realtime = wholetime[:10]
...
# ==============================================================================
# Views (User Authentication & Index2)
# ==============================================================================
def index2(request):
...
def usersmain(request, pageindex=None):
    global page1u
    pagesize = 20
    newsall = models.NewsUnit.objects.all().order_by('-id')
    datasize = len(newsall)
...
def BigMoney(request):
    if request.method == "POST":
        ...
        wholetime = str(datetime.datetime.now()) 
        realtime = wholetime[:16]
        stock_name, pBoard, pForeign, pInvest, pSecurity, pBig, pIndiv =func4.InstituRate(mess)
    else:
        mess = "台股代號尚未送出！"
